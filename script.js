  ...
  if (contactForm) {
    contactForm.addEventListener('submit', function(e) {
      ...
      for (let i = 0; i < formElements.length; i++) {
        ...
        } else if (field.type === 'tel' && field.value && field.hasAttribute('pattern')) {
    ...
    "translations": {
      "he": {
        "consentModal": {
          ...
          "description": "קייל אלומיניום משתמש בעוגיות כדי לשפר את החוויה שלך, לנתח שימוש באתר ולסייע במאמצי השיווק שלנו.",
    ...
    contactForm.addEventListener('submit', async function(e) {
        ...
        try {
            ...
            const response = await fetch('https://api.zappy5.com/api/email/contact-form', {
                ...
                body: JSON.stringify({
                    websiteId: 'ec362847-0c24-462f-91ba-0712d59f9d25',
                    name: data.name || '',
                    email: data.email || '',
